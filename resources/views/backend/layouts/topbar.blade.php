<div class="app-header">
    <div class="app-header__logo">
        <div class="logo-src">    <div class="logo-src"><img class="logo-scalping" src="{{ asset('assets/images/newlogo.png') }}" alt="Image">
        </div>
                        ...
                        <div class="widget-content-left">
                            <div class="btn-group">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true"
                                     class="dropdown-menu dropdown-menu-right" style="background-color:rgb(0, 0, 0)">
