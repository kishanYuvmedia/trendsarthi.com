        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li>
                    ...
                    <ul>
                        <li class="treeview">
                            <a href="{{ URL::to('/user/derivatives/NIFTY') }}">
                                <i class="metismenu-icon"></i><span>NIFTY</span>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="{{ URL::to('/user/derivatives/BANKNIFTY') }}">
                                <i class="metismenu-icon"></i><span>BANKNIFTY</span>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="{{ URL::to('/user/derivatives/FINNIFTY') }}">
                                <i class="metismenu-icon"></i><span>FINNIFTY</span>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="{{ URL::to('/user/derivatives/MIDCPNIFTY') }}">
